...
public class TimDonChoDuyetRequest {
    ...
    public TimDonChoDuyetRequest(String appVersion, List<Param> dataHeader, String langID, String stoken) {
        this.appVersion = appVersion;
        this.dataHeader = dataHeader;
        this.langID = langID;
        this.stoken = stoken;
    ...
    public static class Param {
        ...
        public Param(String fromDate, String leaveRecordID, String leaveTypeID, String status, String toDate, String top) {
            FromDate = fromDate;
